...
const Lock = ({ s = 14, c = 'currentColor' }: IconProps) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none">
...
const Sparkles = ({ s = 16, c = 'currentColor' }: IconProps) => (
...
const ArrowRight = ({ s = 16, c = 'currentColor' }: IconProps) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none">
    <path d="M5 12h14M13 6l6 6-6 6" stroke={c} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)

const Chevron = ({ s = 16, c = 'currentColor', dir = 'right' }: ChevronProps) => {
...
const Spark = ({ s = 18 }: { s?: number }) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none">
    <path d="M5 13l4 4L19 7" stroke="#1B7B47" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)

export const Icons = { Back, Close, Help, Lock, Sparkles, ArrowRight, Chevron, Spark }
